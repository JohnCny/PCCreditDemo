...
function addTd(table,frameid){
    ...
    if(table=="dbInformation"){//担保信息
        $("#"+table).append("<tr class='add'>" +
								...
								"</td>" +
								"<td>" +
									"主营业务或职务<input type='text' name='phone_db' value='' onkeyup='value=value.replace(/[^0-9]/g,&apos;&apos;)' maxlength='11' class='tbInput'/><br/>" +
									"<span>&nbsp;</span>" +
								"</td>	" +
								"<td>" +
									"经营地址或工作单位地址<span>	" +
...
//----------------------现金流分析--------------------------
    if(table=="qtfyx"){//其他费用息
        $("#"+table).append("<tr class='insideTb'>"+
								"<td style='width:100px'><input type='text' name='name_cash_flow_assist_0' value='' style='width:80%'/></td>"+
...
//----------------------贷前调查——固定资产清单--------------------------
	if(table=="fdcxd"){//房地产详单
        $("#"+table).append("<tr class='insideTb center'>"+								
								...
								"<td>"+
									"<input type='text' name='total' onkeyup='checkNUM(this)' maxlength='10' onblur='zjz(this,\"purchase_price\",\"total\",\"total_price\");zjl(this,\"total_price\",\"rate\",\"rate_price\");sub()'/>"+	
								"</td>"+
								"<td>"+
								...
								"</td>"+
								"<td>"+
									"<input type='text' name='total_price' class='subData1' onclick='setJe(this)' value=''/>"+
								"</td>"+
								"<td>"+
									"<input type='text' class='subData2' name='rate_price' onclick='setJe(this)' value='' onkeyup='setJe(this)' onblur='sub()' />"+
...
//----------------------贷前调查——库存--------------------------
	if(table=="kcxx"){//库存信息
        $("#"+table).append("<tr class='insideTb center'>"+								
								...
								"<td>"+
									"<span>"+	
										"<input type='text' name='purchase_total_price' class='subData2' onclick='setJe(this)' value='' /><br/>"+							
									"</span>"+
								"</td>"+
								"<td>"+
									"<span>"+	
